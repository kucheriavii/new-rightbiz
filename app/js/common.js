$(function() {
    ...
    headerMain()//добавляем заголовок на главную

});

function headerMain(){
    var namet = $(".main-page-articles .article__thumbnail").text();
    $(".main-page-articles .article-wrap .container").prepend("<h2 class='article-wrap-header'>"+namet+"</h2>");
}
